...
public class PersonControllerXmlTest extends AbstractIntegrationTest {
	...
	public void testFindAll() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals(455, foundPersonOne.getId());
		
		assertEquals("Amy", foundPersonOne.getFirstName());
		assertEquals("Hubane", foundPersonOne.getLastName());
		assertEquals("161 Knutson Center", foundPersonOne.getAddress());
		...
		assertEquals(769, foundPersonSix.getId());
		
		assertEquals("Andria", foundPersonSix.getFirstName());
		assertEquals("Paybody", foundPersonSix.getLastName());
		assertEquals("68716 Brickson Park Hill", foundPersonSix.getAddress());
	...
	public void testFindByName() throws JsonMappingException, JsonProcessingException {
		...
		PersonVO foundPersonSix = people.get(0);
		...
		assertEquals(551, foundPersonSix.getId());
		
		assertEquals("Hamid", foundPersonSix.getFirstName());
		assertEquals("Eagan", foundPersonSix.getLastName());
		assertEquals("21 Anthes Terrace", foundPersonSix.getAddress());
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		//No content do Postman alterei o Accept para application/xml
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/655</href></links>"));
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/957</href></links>"));
		assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/person/v1/478</href></links>"));
