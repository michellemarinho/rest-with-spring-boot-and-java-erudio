...
public class JwtTokenProvider {
	...
	/*Qdo o spring inicia o contexto, ele cria instancias dos beens anotados e processa as anotations e injeta as dependencias, 
	 * depois chama o PostConstruct, mas antes instancia a classe, portanto nao e possivel injetar a 
	...
	//Implementando a criacao do token
	...
	//estrutura para gerar o access token/aqui será setada a url de onde o token foi gerado
	...
	// Colar o Encoded eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJsZWFuZHJvIiwicm9sZXMiOlsiQURNSU4iLCJNQU5BR0VSIl0sImlzcyI6Imh0dHA6Ly9sb2NhbGhvc3Q6ODA4MCIsImV4cCI6MTY1MjcxOTUzOCwiaWF0IjoxNjUyNzE1OTM4fQ.muu8eStsRobqLyrFYLHRiEvOSHAcss4ohSNtmwWTRcY
	/* no campo PAYLOAD digitar o codigo abaixo, e alterar a signature para 53cr37
