...
public class Book implements Serializable{
	...
	@Column (name = "launchDate", nullable = false) //indica como será chamado no banco
	...
	@Column (nullable = false, length = 250)//indica como será chamado no banco e tamanho do campo
