...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler(ResourceNotFoundException.class) //trata as exceções..
	...
	@ExceptionHandler(RequiredObjectIsNullException.class) //trata as exceções..
	...
	@ExceptionHandler(InvalidJwtAuthenticationException.class) //trata as exceções..
