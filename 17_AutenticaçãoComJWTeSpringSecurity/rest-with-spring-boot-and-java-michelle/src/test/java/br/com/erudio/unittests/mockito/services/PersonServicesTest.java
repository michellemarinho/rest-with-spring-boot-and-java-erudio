...
class PersonServicesTest {
	...
	@Test //Nesse teste, ao mockar a expressão "repository.findById(id)", será recbido um link c um padrão específico.
	void testFindById() {
		...
		when(repository.findById(1L)).thenReturn(Optional.of(entity)); //abaixo ocorre o seguinte: qdo o repository.findById for chamado, não vai ao banco, o mockito interceptar e retornar um mock
	...
	void testCreate() {
		...
		when(repository.save(entity)).thenReturn(persisted); //abaixo ocorre o seguinte: qdo o repository.findById for chamado, não vai ao banco, o mockito intercepta e retornar um mock e qdo salvar, retorna a minha entidade persistida no bd
	...
	void testUpdate() {
		...
		PersonVO vo = input.mockVO(1);
		vo.setKey(1L); //abaixo ocorre o seguinte: qdo o repository.findById for chamado, não vai ao banco, o mockito intercepta e retornar um mock
