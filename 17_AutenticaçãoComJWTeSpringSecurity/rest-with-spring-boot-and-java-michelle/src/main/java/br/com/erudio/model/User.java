...
public class User implements UserDetails, Serializable{
	...
	@ManyToMany (fetch = FetchType.EAGER)//Aqui teremos o mapeamento do ManyToMany, Q diz: buscou o usuário, traga tbm suas permissões
	...
	public List<String> getRoles(){
		...
		for(Permission permission : permissions) {
			roles.add(permission.getDescrition());
		}
		return roles;
	}
